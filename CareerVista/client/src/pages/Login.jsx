    ...
    <div className="auth-container">
      ...
      <div className="auth-background">
        <div className="background-content">
          <h2>Architect Your Future with Personalized Career Guidance</h2>
          <p>DishaGen+ goes beyond generic advice to craft your unique destiny. Our neuroscience-inspired AI maps your neural blueprint to create hyper-personalized career pathways.</p>
